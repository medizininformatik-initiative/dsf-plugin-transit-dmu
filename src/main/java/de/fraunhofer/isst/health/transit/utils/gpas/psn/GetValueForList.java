...
/**
 * <p>Java class for getValueForList complex type</p>.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 *
 * <pre>{@code
 * <complexType name="getValueForList">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="psnList" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
...
@XmlType(name = "getValueForList", propOrder = {
        "psnList",
        "domainName"
})
public class GetValueForList {
