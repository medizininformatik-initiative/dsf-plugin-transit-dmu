...
public class SetTargetAndCorrelationKey extends AbstractServiceDelegate
{
	private static final Logger logger = LoggerFactory.getLogger(SetTargetAndCorrelationKey.class);

	public SetTargetAndCorrelationKey(ProcessPluginApi api)
	{
		super(api);
	}
	...
	protected void doExecute(DelegateExecution execution, Variables variables) throws BpmnError, Exception
	{
		...
		List<Resource> tasks = variables.getResourceList(BPMN_EXECUTION_TASK_LIST);
