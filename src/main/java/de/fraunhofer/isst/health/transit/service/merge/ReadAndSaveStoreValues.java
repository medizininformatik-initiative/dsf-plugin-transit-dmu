...
public class ReadAndSaveStoreValues extends AbstractServiceDelegate {
    ...
    public ReadAndSaveStoreValues(ProcessPluginApi api, DmsProjectFileFhirClientConfig dmsProjectFileFhirClientConfig) {
        super(api);
    ...
    protected void doExecute(DelegateExecution delegateExecution, Variables variables) throws BpmnError, Exception {
        ...
        for (Task.ParameterComponent param : params) {
            if (!param.isEmpty() && param.getType().hasCoding(SYSTEM, CODE)) {
                ...
                delegateExecution.setVariable(ConstantsTransit.FHIRSTOREURL, url.getValue());
